...
namespace TheReviewer.Core
{
    public class ADB2C_Constants
    {
        ...
        public static string[] ApplicationScopes = new string[] {

        };

        public static string[] CoolScope = new string[] { $"https://{Tenant}/cooltest/cool_app_write" };

        public static string[] RegularScope = new string[]
        {$"https://{Tenant}/backend/rvw.read.only"};
